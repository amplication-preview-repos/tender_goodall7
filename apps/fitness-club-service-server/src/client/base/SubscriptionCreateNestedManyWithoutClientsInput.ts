...
@InputType()
class SubscriptionCreateNestedManyWithoutClientsInput {
...
export { SubscriptionCreateNestedManyWithoutClientsInput as SubscriptionCreateNestedManyWithoutClientsInput };
